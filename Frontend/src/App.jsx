  ...
  return <Dialog>
    ...
    <DialogContent className="game-instructions sm:max-w-lg">
      ...
      <ol className="instructions">
        ...
        <li><strong>Get in frame.</strong> Keep both shoulders, elbows, and hands visible. Your character mirrors your movement. Chest cues arrive from the upper corners; hip cues from the lower corners.</li>
