    ...
    <div className="game-columns" data-input={input}>
      <section className="highway-panel rhythm-stage" aria-label="Corner pose game">
        <div className="canvas-wrap">
          ...
          <canvas ref={canvas} aria-label="Chest cues fly from the upper corners; hip cues from the lower corners. Match the pose as its cue enters the ring beside your character." />
