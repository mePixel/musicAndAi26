...
export const songs = [
  { id: 'first-groove', title: 'First Groove', bpm: 96, duration: 40, mood: 'Warm bass. Easy moves.',
    color: '#d9ff70', audioUrl: '/audio/first-groove.mp3',
  ...
  { id: 'disco-circuit', title: 'Disco Circuit', bpm: 156, duration: 36, mood: 'A little faster. A little funkier.',
    color: '#bea7ff', audioUrl: '/audio/disco-circuit.mp3',
